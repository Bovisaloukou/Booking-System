...
return [
    ...
    'description' => 'RESTful API for a booking/reservation system with Stripe payments, multi-role access control, and real-time notifications.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Retrieve your token via the <b>POST /api/login</b> or <b>POST /api/register</b> endpoints, then include it as <code>Authorization: Bearer {token}</code>.',
    ],
